...
## Methodology
Risk evaluation based on Impact vs Likelihood following ISO 27001 principles.

- Impact: Business damage (financial, operational, reputational)
...
1. Production downtime (critical)
2. Phishing attacks (high likelihood)
3. Supplier vulnerabilities (strategic risk)
